...
/**
 * doc_user_selection data structure
 * https://boxalino.atlassian.net/wiki/spaces/BPKB/pages/252313673/doc+user+selection
 */
class UserSelection implements DocPropertiesInterface
{
    use PropertyToTrait;
    ...
    /**
     * the creation date time of the us
     * @var string | null
     */
    protected $creation;

    /**
     * the last update date time of the us
     * @var string | null
     */
    protected $last_update;

    /**
     * the persona type who created this us
     * @var string | null
     */
    protected $persona_type;

    /**
     * the persona who created this us
     * @var string | null
     */
     ...
     * @return self
     */
    public function setPersonaType(?string $persona_type): self
    {
     ...
     * @return self
     */
    public function setPersonaId(?string $persona_id): self
    {
     ...
     * @return $this
     */
    public function setValue(float|int $value): UserSelection
    {
        $this->value = $value;
        return $this;
    }
